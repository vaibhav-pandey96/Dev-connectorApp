...
const About = () => {
  ...
  return (
    <div className='w-full h-screen p-5 flex flex-col items-center justify-evenly'>
        <section className='text-center flex flex-col md:gap-5 gap-2'>
            ...
            <p className='text-xs md:text-2xl'>DevConnector is a full stack developer community platform where coder from
        ...
        <section className='text-center flex flex-col md:gap-4 gap-2'> 
